...
<body>
	...
	<div style="max-width: 1300px; margin: 0 auto;">
		<table class="table table-bordered table-striped text-center">
            ...
            %>
				<tr>
					<td colspan="5" class="text-center text-muted">No products
						available</td>
				</tr>
				<% } %>
			</tbody>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="ProductServlet" method="post">
						...
						<div class="mb-3">
							<label class="form-label">Launch Date</label> <input type="date"
								name="launch_date" class="form-control" required>
						</div>
