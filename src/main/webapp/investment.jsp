...
<body>
	<div
		...
		<button class="btn btn-primary" data-bs-toggle="modal"
			data-bs-target="#addProductModal">Add Investment</button>
	</div>
	...
	<div style="max-width: 1300px; margin: 0 auto;">
        ...
        %>
				<tr>
					<td colspan="5" class="text-center text-muted">No investments
						recorded</td>
				</tr>
				<% } %>
			</tbody>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="InvestmentServlet" method="post">
						...
						<div class="mb-3">
							<label class="form-label">Month</label> <input type="text"
								name="month" class="form-control"
								placeholder="Enter month (e.g. Jan-2025)" required>
						</div>
						<div class="mb-3">
							<label class="form-label">Investment Type</label> <input
								type="text" name="investmentType" class="form-control"
								placeholder="Enter investment type" required>
						</div>
						<div class="mb-3">
							<label class="form-label">Amount</label> <input type="number"
								step="0.01" name="amount" class="form-control"
