...
<body>
	...
	<div
		...
		<button class="btn btn-primary" data-bs-toggle="modal"
			data-bs-target="#addProductModal">Add Sale</button>
	</div>
	<div style="max-width: 1300px; margin: 0 auto;">
        ...
        %>
				...
				<% } } else { %>
				<tr>
					<td colspan="5" class="text-center text-muted">No sales
						recorded</td>
				</tr>
				<% } %>
			</tbody>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="SaleServlet" method="post">
						...
						<div class="mb-3">
							<label class="form-label">Revenue</label> <input type="number"
								step="0.01" name="revenue" class="form-control"
								placeholder="Enter revenue" required>
						</div>
						<div class="mb-3">
							<label class="form-label">Sale Date</label> <input type="date"
								name="saleDate" class="form-control" required>
						</div>
